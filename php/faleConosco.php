...
// $msg = isset($_POST['exampleFormControlTextarea1']) ? $_POST['exampleFormControlTextarea1'] : "Sem Mensagem"; //PEGA A MENSAGEM DIGITADA, CASO NAO DIGITE NADA RETORNA 'SEM MENSAGEM'
